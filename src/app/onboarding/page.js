        ...
        <div className="bg-bgSecondary h-screen">
            <div className="pt-[154px]">
                <div className="grid place-items-center">
                    <Image src="/svg/image-onboarding.svg" alt="image onboarding" width={179} height={179} />
                </div>
                <h1 className="font-semibold text-primary w-full text-center text-[52.14px] pt-3">
                    Plastic - In
                </h1>
                <p className="text-sm font-normal text-center pt-2 pb-11">Selamat Datang Di Plastic-In! </p>
            </div>
